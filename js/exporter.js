...
(function () {
  ...
  function getSlideshowJS(total) {
    return [
      ...
      'var uiTimer = null, lastKeyNav = 0;',
      'function showUi() {',
      '  if (Date.now() - lastKeyNav < 600) return;',
      ...
      '  if (e.key === "ArrowRight" || e.key === " ") { e.preventDefault(); lastKeyNav = Date.now(); hideUi(); next(); }',
      '  else if (e.key === "ArrowLeft") { e.preventDefault(); lastKeyNav = Date.now(); hideUi(); prev(); }',
